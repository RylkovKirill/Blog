...
namespace Blog.Migrations
{
    ...
    [Migration("20201125132125_AddCategoryCreatedDate")]
    partial class AddCategoryCreatedDate
    {
            ...
            modelBuilder.Entity("Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ad56d321-43ee-483b-b724-492d0c27181d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBuH6oyzxu8VbmewHy06qwucnDkI3ei8j5OFe2zXJqwYGb2h3kqkfxMKBjIKaRdL+Q==",
            ...
            modelBuilder.Entity("Entities.PostCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 11, 25, 16, 21, 24, 81, DateTimeKind.Local).AddTicks(3290),
                            Name = "Дом и сад"
                        },
                        new
                        {
                            Id = new Guid("cab6fa8f-6467-4f1f-9267-af8d35d3a0a7"),
                            CreatedDate = new DateTime(2020, 11, 25, 16, 21, 24, 82, DateTimeKind.Local).AddTicks(8920),
                            Name = "Еда и напитки"
                        },
                        new
                        {
                            Id = new Guid("5177e626-a357-4722-af79-9a9efb43193e"),
                            CreatedDate = new DateTime(2020, 11, 25, 16, 21, 24, 82, DateTimeKind.Local).AddTicks(9088),
                            Name = "Здоровье и фитнес"
                        },
                        new
                        {
                            Id = new Guid("b9afdb0b-87f1-484a-886d-a66d591b6cfa"),
                            CreatedDate = new DateTime(2020, 11, 25, 16, 21, 24, 82, DateTimeKind.Local).AddTicks(9118),
                            Name = "Наука и техника"
                        },
                        new
                        {
                            Id = new Guid("d1ef5ca8-6510-4768-9207-b1aac15989fd"),
                            CreatedDate = new DateTime(2020, 11, 25, 16, 21, 24, 82, DateTimeKind.Local).AddTicks(9141),
                            Name = "Новости и политика"
                        },
                        new
                        {
                            Id = new Guid("e2fe0327-4d9a-4d6f-ba7c-4f58a107fd15"),
                            CreatedDate = new DateTime(2020, 11, 25, 16, 21, 24, 82, DateTimeKind.Local).AddTicks(9170),
                            Name = "Развлечение"
                        },
                        new
                        {
                            Id = new Guid("e6fd90a4-ffbc-498b-a3d8-646ae10784a9"),
                            CreatedDate = new DateTime(2020, 11, 25, 16, 21, 24, 82, DateTimeKind.Local).AddTicks(9193),
                            Name = "Разное"
                        },
                        new
                        {
                            Id = new Guid("2c1bd27d-1cf7-46bd-ad38-ae8b0199eedf"),
                            CreatedDate = new DateTime(2020, 11, 25, 16, 21, 24, 82, DateTimeKind.Local).AddTicks(9216),
                            Name = "Спорт"
                        });
                });
            ...
            modelBuilder.Entity("Entities.ReportCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2020, 11, 25, 13, 21, 24, 83, DateTimeKind.Utc).AddTicks(213),
                            Name = "Контент сексуального характера"
                        },
                        new
                        {
                            Id = new Guid("0d50b5d6-2274-4f74-a478-7671242e1348"),
                            CreatedDate = new DateTime(2020, 11, 25, 13, 21, 24, 83, DateTimeKind.Utc).AddTicks(1093),
                            Name = "Жестокие или отталкивающие сцены"
                        },
                        new
                        {
                            Id = new Guid("83ba1239-4ef7-44a7-ae91-c5c9d0e6c100"),
                            CreatedDate = new DateTime(2020, 11, 25, 13, 21, 24, 83, DateTimeKind.Utc).AddTicks(1144),
                            Name = "Оскорбления или проявления нетерпимости"
                        },
                        new
                        {
                            Id = new Guid("06568472-51b4-4292-b7e0-a220b789c885"),
                            CreatedDate = new DateTime(2020, 11, 25, 13, 21, 24, 83, DateTimeKind.Utc).AddTicks(1171),
                            Name = "Вредные или опасные действия"
                        },
                        new
                        {
                            Id = new Guid("520eeb61-256a-4edd-9476-5fbe69cc3f20"),
                            CreatedDate = new DateTime(2020, 11, 25, 13, 21, 24, 83, DateTimeKind.Utc).AddTicks(1195),
                            Name = "Жестокое обращение с детьми"
                        },
                        new
                        {
                            Id = new Guid("516fff94-dfd1-4c94-bebd-9498048eac3d"),
                            CreatedDate = new DateTime(2020, 11, 25, 13, 21, 24, 83, DateTimeKind.Utc).AddTicks(1225),
                            Name = "Нарушение моих прав"
                        },
                        new
                        {
                            Id = new Guid("bacc901a-c8fd-4f8c-b4f7-30e8a5b0d502"),
                            CreatedDate = new DateTime(2020, 11, 25, 13, 21, 24, 83, DateTimeKind.Utc).AddTicks(1249),
                            Name = "Пропаганда терроризма"
                        },
                        new
                        {
                            Id = new Guid("7eca2608-2bf8-482b-a630-8e7eb2bc8724"),
                            CreatedDate = new DateTime(2020, 11, 25, 13, 21, 24, 83, DateTimeKind.Utc).AddTicks(1272),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "aa86cc43-00c4-4c86-ae84-8bd4816eac81",
                            Name = "admin",
