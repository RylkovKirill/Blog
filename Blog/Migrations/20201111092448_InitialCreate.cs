        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostTag_Tags_PostId",
                        column: x => x.PostId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostTag_Posts_TagId",
                        column: x => x.TagId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("7eca2608-2bf8-482b-a630-8e7eb2bc8724"), null, "Спам или ложная информация" },
                    { new Guid("6c8b430f-99bf-460d-903e-198728353a72"), null, "Контент сексуального характера" },
                    { new Guid("0d50b5d6-2274-4f74-a478-7671242e1348"), null, "Жестокие или отталкивающие сцены" },
                    { new Guid("83ba1239-4ef7-44a7-ae91-c5c9d0e6c100"), null, "Оскорбления или проявления нетерпимости" },
                    { new Guid("06568472-51b4-4292-b7e0-a220b789c885"), null, "Вредные или опасные действия" },
                    { new Guid("520eeb61-256a-4edd-9476-5fbe69cc3f20"), null, "Жестокое обращение с детьми" },
                    { new Guid("516fff94-dfd1-4c94-bebd-9498048eac3d"), null, "Нарушение моих прав" },
                    { new Guid("bacc901a-c8fd-4f8c-b4f7-30e8a5b0d502"), null, "Пропаганда терроризма" }
                });
